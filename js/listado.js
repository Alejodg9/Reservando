...
Listado.prototype.buscarRestaurante = function(id) {
  ...
  function buscarId(restaurantes) {
    return restaurantes.id === id;
  }
  return this.restaurantes.find(buscarId);
};

//función que elimina los elementos repetidos de un arreglo
function filtrarArray(arrayAFiltrar) {
  return arrayAFiltrar.filter(function(elem, index, self) {
...
Listado.prototype.obtenerUbicaciones = function() {
  ...
  var resultado = filtrarArray(ciudades);
...
Listado.prototype.obtenerRubros = function() {
  ...
  var resultado = filtrarArray(rubros);
...
Listado.prototype.obtenerHorarios = function() {
  ...
  var horarios = this.restaurantes.map(function(restaurante) {
    return restaurante.horarios;
  });

  var resultado = filtrarArray(horarios.flat());
  return resultado.sort();
};
